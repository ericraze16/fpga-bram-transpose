...
help:
	...
	@echo "  run_verilator - Compile and run the transpose engine rtl/testbench. "
	@echo "  	Set MATRIX_DIM to change matrix size."
	@echo "  run_ver_ram - Compile and run the m20k bram model rtl/testbench."
	@echo "  	Set LOG_WIDTH/DEPTH to change logical width/depth. The current test bench doesn't support logical widths > 32 bit."
	@echo "  build - Build the transpose engine executable"
	@echo "  build_ram - Build the m20k bram model executable"
	@echo "  run - Run the transpose engine executable"
